...
<script type="text/javascript">
    ...
    function deleteBatch() {
        ...
        //取得所有被选中删除商品的pid
        const cks = $("input[name=ck]:checked");
        ...
        if (cks.length == 0) {
            ...
            if (confirm("您确定删除" + cks.length + "条商品吗？")) {
                ...
                //发送ajax请求
                $.ajax({
                    url: "http://localhost:8080${pageContext.request.contextPath}/prod/deleteBatch.action",
                    data: {"pids": str},
                    type: "post",
                    dataType: "text",
    ...
    function del(pid,page) {
        if (confirm("确定删除吗")) {
            ...
            $.ajax({
                url: "http://localhost:8080${pageContext.request.contextPath}/prod/delete.action",
...
<script type="text/javascript">
    function ajaxSplit(page) {
        ...
        //异步ajax分页请求
        $.ajax({
            url: "http://localhost:8080${pageContext.request.contextPath}/prod/ajaxSplit.action",
